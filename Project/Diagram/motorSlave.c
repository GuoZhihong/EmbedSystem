...
void initWheels()
{
	...
	*/
	...
	//PB2 is unused, and PB6 and 7 are for testing
	
	//set a timer to control the wheels 
    TCCR0A |= (1 << COM0A1) | (1 << WGM01) | (1<< WGM00);  	//clear OC0B on compare match with fast PWM
...
//Directional control methods grouped by wheels and side of cars.
void backFwd()
{
	//BACK LEFT wheel
	PORTB |= (1<< PB6);
